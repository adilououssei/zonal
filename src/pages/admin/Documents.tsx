    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-5">
        <div className="relative flex-1">
          ...
          <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Rechercher un document..." className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-200 text-small focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition" />
        </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {filtered.length > 0 ? (
                  ...
                  <tr><td colSpan={5} className="px-5 py-10 text-center text-gray-400 text-small">Aucun document trouvé.</td></tr>
                )}
              </tbody>
            </table>
          </div>
