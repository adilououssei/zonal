...
import {
  ...
  AlignLeft, Quote, Plus, Calendar, Clock, MapPin
} from 'lucide-react'
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-small mt-1">
          Tableau de bord &gt; Événements &gt; {isEditing ? 'Modifier' : 'Ajouter'}
        </p>
      </div>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-small font-medium text-gray-700 mb-2">Titre de l'événement</label>
              <input
                type="text"
                value={title}
                onChange={(e) => setTitle(e.target.value)}
                placeholder="Ex : Journée mondiale de l'environnement"
            ...
            <div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                <textarea
                  ...
                  placeholder="Rédigez la description de l'événement..."
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-small font-medium text-gray-700 mb-2">Heure</label>
              <div className="relative">
                <input
                  type="text"
                  value={time}
